// ======================================================================
// \title  NmfCommunicationDemoTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef NMFCOMMUNICATIONDEMO_NMFCOMMUNICATIONDEMOTOPOLOGY_HPP
#define NMFCOMMUNICATIONDEMO_NMFCOMMUNICATIONDEMOTOPOLOGY_HPP
// Included for access to NmfCommunicationDemo::TopologyState and NmfCommunicationDemo::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ApplicationUnit/NmfCommunicationDemo/Top/NmfCommunicationDemoTopologyDefs.hpp>
 ...
 * NmfCommunicationDemo::TopologyState see: NmfCommunicationDemoTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type ApplicationUnit::TopologyState see: ApplicationUnitTopologyDefs.hpp.
 *
