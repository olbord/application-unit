// ======================================================================
// \title  NmfCommunicationDemoTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <ApplicationUnit/NmfCommunicationDemo/Top/NmfCommunicationDemoTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <ApplicationUnit/NmfCommunicationDemo/Top/NmfCommunicationDemoPacketsAc.hpp>

// Necessary project-specified types
#include <Fw/Types/MallocAllocator.hpp>

// Public functions for use in main program are namespaced with deployment module ApplicationUnit
...
void setupTopology(const TopologyState& state) {
	...
	Os::TaskString tcpTaskName("TcpServerTask");
	tcpServer.start(tcpTaskName, COMM_PRIORITY, Default::STACK_SIZE);
}
