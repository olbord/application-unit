...
#include <ApplicationUnit/NmfCommunicationDemo/Top/NmfCommunicationDemoTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    ApplicationUnit::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    ApplicationUnit::TopologyState inputs;
    ...
    ApplicationUnit::setupTopology(inputs);
    ApplicationUnit::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    ApplicationUnit::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
